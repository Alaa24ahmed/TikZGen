...
async def generate_sequential_combinations(elements, code, png_folder, code_folder, output_folder, options, begin_commands, sum, max_combinations=50):
